...
const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    description: "Spend your hard-earned coins on: ⬆️ Jump & Speed boosts, 🛡️ Shield (extra life), 🧲 Coin Magnet, 🎨 Visual Themes, and 🎵 Music tracks!",
    emoji: "🛒",
    visual: "⬆️ 🛡️ 🧲 🎨 🎵",
  },
  {
    title: "Boss Battles ⚡",
    description: "Every 5th level is a boss fight! Use number keys 1-5 to cast spells: ⚡ Stupefy, ✨ Expelliarmus, ❄️ Petrificus, and more. Dodge the boss's attacks and fight back!",
    emoji: "🐉",
    visual: "⚡ ✨ ❄️ 🔥 💜",
  },
  {
    title: "Themes & Music 🎨",
    description: "Purchase themes in the shop to transform the entire game's look — Amortentia Pink 💖, Ravenclaw Blue 💙, Dark Arts 🐍, and more! Each music track sets a different mood.",
    emoji: "🎵",
    visual: "💖 💙 🐍 💛 🖤",
  },
  {
