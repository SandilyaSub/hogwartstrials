...
export const WORLDS: World[] = [
  ...
  },
  {
    ...
    levels: [
      ...
      { id: "4-3", name: "Dragon Duel", description: "First Task — fly your Firebolt to seize the Golden Egg!", isBoss: false, theme: "arena" },
      ...
      { id: "4-7", name: "Triwizard Maze", description: "Third Task — enchanted hedges", isBoss: false, theme: "maze" },
      { id: "4-8", name: "Graveyard", description: "Portkey to Little Hangleton", isBoss: false, theme: "dark" },
      { id: "4-9", name: "Priori Incantatem", description: "Echoes of past spells", isBoss: false, theme: "magic" },
      { id: "4-10", name: "Voldemort Returns", description: "Outrun the Horntail's fury!", isBoss: true, theme: "boss" },
    ],
  },
  {
  ...
  },
  {
    ...
    levels: [
      ...
      { id: "7-5", name: "Gringotts Escape", description: "Ride the Ironbelly out of the bank!", isBoss: false, theme: "flying" },
