...
export const WORLDS: World[] = [
  ...
  },
  {
    ...
    levels: [
      ...
      { id: "5-5", name: "Room of Requirement", description: "The room shifts around you", isBoss: false, theme: "magic" },
      { id: "5-6", name: "Umbridge's Office", description: "Dodge the cat plates", isBoss: false, theme: "office" },
      { id: "5-7", name: "Thestral Flight", description: "Fly invisible mounts", isBoss: false, theme: "flying" },
      { id: "5-8", name: "Veil Chamber", description: "Death's archway awaits", isBoss: false, theme: "dark" },
      { id: "5-9", name: "Dumbledore's Army", description: "Final D.A. showdown", isBoss: false, theme: "training" },
      { id: "5-10", name: "Battle Run", description: "Battle in the Ministry!", isBoss: true, theme: "boss" },
    ],
  },
  {
