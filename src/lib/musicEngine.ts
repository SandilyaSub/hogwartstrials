...
const SONGS: Record<string, { melody: Note[]; bpm: number; waveform: OscillatorType; harmonicMul: number; label: string }> = {
  default: {
    ...
    harmonicMul: 3,
    melody: [
      // Phrase 1: pickup B4 → E5. G5 F#5 | E5 B5 | A5... | F#5...
      [493.88, 1],
      [659.25, 1.5], [783.99, 0.5], [739.99, 1],
      [659.25, 2], [987.77, 1],
      [880.00, 3],
      [739.99, 3],
      // Phrase 2: E5. G5 F#5 | D#5 F5 | B4...
      [659.25, 1.5], [783.99, 0.5], [739.99, 1],
      [622.25, 2], [698.46, 1],
      [493.88, 3],
      [493.88, 2],
      // Phrase 3: pickup B4 → E5. G5 F#5 | E5 B5 | D6 C#6 | A5 C#6
      [493.88, 1],
      [659.25, 1.5], [783.99, 0.5], [739.99, 1],
      [659.25, 2], [987.77, 1],
      [1174.66, 1.5], [1108.73, 0.5], [880.00, 1],
      [1108.73, 2], [880.00, 1],
      // Phrase 4: G#5 B5 | G5. E5...
      [830.61, 1.5], [987.77, 0.5], [830.61, 1],
      [783.99, 2], [659.25, 1],
      [659.25, 3],
      [0, 2],
    ],
