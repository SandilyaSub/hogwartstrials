...
const SONGS: Record<string, { melody: Note[]; bpm: number; waveform: OscillatorType; harmonicMul: number; label: string }> = {
  default: {
    ...
    harmonicMul: 3,
    melody: [
      // Phrase 1 (A): B4 | E5. G5 F#5 | E5 B5 | A5... | F#5...
      [493.88, 1],
      [659.25, 1.5], [783.99, 0.5], [739.99, 1],
      [659.25, 2], [987.77, 1],
      [880.00, 3],
      [739.99, 3],
      // Phrase 2 (A'): E5. G5 F#5 | Eb5 F5 | B4...
      [659.25, 1.5], [783.99, 0.5], [739.99, 1],
      [622.25, 2], [698.46, 1],
      [493.88, 3],
      [0, 1], [493.88, 1],
      // Phrase 3 (B): E5. G5 F#5 | E5 B5 | D6 C#6 A5 | C#6 B5
      [659.25, 1.5], [783.99, 0.5], [739.99, 1],
      [659.25, 2], [987.77, 1],
      [1174.66, 1], [1108.73, 1], [880.00, 1],
      [1108.73, 2], [987.77, 1],
      // Phrase 4 (B'): G#5 B5 G#5 | G5 E5 | E5...
      [830.61, 1], [987.77, 1], [830.61, 1],
      [783.99, 2], [659.25, 1],
      [659.25, 3],
      [0, 3],
    ],
